...
public class ProgConsole extends MessageConsole implements ProcessConsole {
	
	private final ProcessConsoleContext context = new ProcessConsoleContext();
	
	public ProgConsole() {
		super("CC Prog Console", CcUIPlugin.getImageDescriptor("icons/make_flash_mem.gif"));
	}
